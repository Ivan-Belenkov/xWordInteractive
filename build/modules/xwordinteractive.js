...
/***/ function(module, exports, __webpack_require__) {
	...
	var InhabitModuleBase = __webpack_require__(1).InhabitModuleBase;
	var DefaultConfiguration = __webpack_require__(4);
	var xWordInteractiveView = __webpack_require__(5);
	var d3 = __webpack_require__(6);
	var Crossword = __webpack_require__(7);
	var updateDataSelection = __webpack_require__(8);
	var setXWordSize = __webpack_require__(9);
	var checkSolution = __webpack_require__(10);
	var dataHelper = __webpack_require__(11);
	 ...
	 * @constructor
	 */
	var xWordInteractive = function xWordInteractive(configuration, dependencies) {
	...
	xWordInteractive.prototype = Object.create(InhabitModuleBase.prototype);
	xWordInteractive.prototype.constructor = xWordInteractive;
	xWordInteractive.moduleName = "xwordinteractive";
	/**
	 * Start async task that fetches content and return a this.deffered.promise()
	 * @returns {Promise}
	 */
	xWordInteractive.prototype.getContent = function () {
	 ...
	 * @returns {string}
	 */
	xWordInteractive.prototype.getThumbnail = function () {
	    return "";
	};
	 ...
	 * @returns {string}
	 */
	xWordInteractive.prototype.getTitle = function () {
	    return "xWordInteractive";
	};

	/**
	 * @returns {boolean}
	 */
	xWordInteractive.prototype.hasContent = function () {
	    return true;
	};
	 ...
	 * @return {string}
	 */
	xWordInteractive.prototype.display = function () {
	    var self = this;
	    var compiledTemplate = this.handlebars.compile(xWordInteractiveView);
	    ...
	    self.mismatchHighliting = false;
	    self.lettersArray = [];

	    setTimeout(function () {
	        var resizeTimer;
	        dataHelper(self, grid);

	        setXWordSize(self, grid);
	        ...
	        self.$("ark-xword-container").on("click", ".ark-xword-cell-word", function () {
	            var words = self.$(this).data("words"),
	                dataItem = self.$(this).data().dataItem,
	                word;

	            if (!dataItem.selected) {
	                word = words[0];
	            } else {
	                if (dataItem.current && words.length > 1) {
	                    word = dataItem.selectedWord == words[0] ? words[1] : words[0];
	                }
	                if (!dataItem.current || words.length == 1) {
	                    word = dataItem.selectedWord;
	                }
	            }
	            updateDataSelection(self, grid, word);
	            dataItem.current = true;
	            dataHelper(self, grid, true);
	            self.$("ark-xword-definition-body").text(legend[word]);
	        });

	        window.onkeypress = function (e) {
	            var inputValue = e.charCode,
	                keyValue = e.keyCode,
	                currentSelected = self.$(".ark-xword-cell-word.current"),
	                checkedSolution;

	            if ((inputValue >= 65 && inputValue <= 90 || inputValue >= 97 && inputValue <= 122) && self.$(".ark-xword-cell-word.current").length) {
	                currentSelected.data().dataItem.char_visible = e.key;

	                checkedSolution = checkSolution(self);

	                if (checkedSolution.complete) {
	                    if (checkedSolution.correct) {
	                        self.$("ark-xword-overlay").addClass("win");
	                    } else {
	                        //show fail
	                        self.mismatchHighliting = true;
	                        self.$("ark-xword-overlay").addClass("fail");
	                    }
	                }

	                dataHelper(self, grid, true);
	                currentSelected.nextAll(".ark-xword-cell-word.selected").filter(function () {
	                    return self.$(this).data().dataItem.char_visible == "";
	                }).eq(0).click();
	                currentSelected.parent().nextAll().find(".ark-xword-cell-word.selected").filter(function () {
	                    return self.$(this).data().dataItem.char_visible == "";
	                }).eq(0).click();
	            }
	            if (keyValue == 37) {
	                // Left
	                currentSelected.prevAll(".ark-xword-cell-word[data-row=" + currentSelected.attr("data-row") + "]").eq(0).click();
	            }
	            if (keyValue == 38) {
	                // Up
	                currentSelected.parent().prevAll().find(".ark-xword-cell-word[data-col=" + currentSelected.attr("data-col") + "]").filter(":last").click();
	            }
	            if (keyValue == 39) {
	                // Right
	                currentSelected.nextAll(".ark-xword-cell-word[data-row=" + currentSelected.attr("data-row") + "]").eq(0).click();
	            }
	            if (keyValue == 40) {
	                // Down
	                currentSelected.parent().nextAll().find(".ark-xword-cell-word[data-col=" + currentSelected.attr("data-col") + "]").eq(0).click();
	            }
	            if (keyValue == 46) {
	                // Delete
	                currentSelected.data().dataItem.char_visible = "";
	                dataHelper(self, grid, true);
	            }
	        };

	        self.$(document).on("click", "ark-xword-overlay.fail", function () {
	            self.mismatchHighliting = false;

	            self.$(this).removeClass("fail");
	            self.lettersArray.forEach(function (item) {
	                item.char_visible = "";
	            });
	            dataHelper(self, grid, true);
	        });
	    ...
	    return compiledTemplate({ styles: styles, greetings: self.configuration.greetings, gridArray: grid });
	};
	 ...
	 * @returns {string}
	 */
	xWordInteractive.prototype.getType = function () {
	    return xWordInteractive.moduleName;
	};

	InhabitModuleBase.publish(xWordInteractive);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	exports.InhabitModuleEvents = __webpack_require__(2);
	exports.InhabitModuleBase = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InhabitModuleEvents = __webpack_require__(2);
	/**
	 * @constructor
	 * @param configuration
	 * @param dependencies
...
/***/ function(module, exports) {
	...
	module.exports = "<style>{{ styles }}</style>\r\n<ark-xword-greetings>\r\n    {{ greetings }}\r\n</ark-xword-greetings>\r\n<ark-xword>\r\n    <ark-xword-container>\r\n        <ark-xword-field class=\"ark-xword\">\r\n            {{#each gridArray}}\r\n                <ark-xword-row class=\"ark-xword-row\">\r\n                    {{#each this}}\r\n                        <ark-xword-cell class=\"ark-xword-cell\"></ark-xword-cell>\r\n                    {{/each}}\r\n                </ark-xword-row>\r\n            {{/each}}\r\n        </ark-xword-field>\r\n    </ark-xword-container>\r\n    <ark-xword-definition>\r\n        <ark-xword-definition-header>Definition:</ark-xword-definition-header>\r\n        <ark-xword-definition-body>\r\n            Click on any cell to see the question\r\n        </ark-xword-definition-body>\r\n    </ark-xword-definition>\r\n</ark-xword>\r\n<ark-xword-overlay>\r\n    <ark-xword-congrat>YOU WIN!!!</ark-xword-congrat>\r\n    <ark-xword-fail>\r\n        <ark-xword-fail-header>Something went wrong</ark-xword-fail-header>\r\n        <ark-xword-fail-annotation>Click anywhere and try one more time</ark-xword-fail-annotation>\r\n    </ark-xword-fail>\r\n</ark-xword-overlay>"
...
/***/ function(module, exports) {
	...
	module.exports = function Crossword(words_in, clues_in) {
	    var GRID_ROWS = 50;
	    var GRID_COLS = 50;
...
/***/ function(module, exports) {
	 ...
	 */
	module.exports = function updateDataSelection(context, grid, word) {
	    grid.forEach(function (row) {
	        row.forEach(function (elem) {
	            if (elem !== null) {
	                elem.selectedWord = word;
	                elem.current = false;
	                elem.selected = elem.across && elem.across.index == word || elem.down && elem.down.index == word;
	            }
	        });
	    });
	};
...
/***/ function(module, exports) {
	 ...
	 */
	module.exports = function setXWordSizeHelper(context, grid) {
	    var tableWidth = grid[0].length,
	        cellWidth = Math.floor((context.$("ark-xword-container").outerWidth() - 40) / tableWidth),
	        fontSize = Math.floor(2 * cellWidth / 3);

	    context.$(".ark-xword-cell").css({
	        height: cellWidth + "px",
	        width: cellWidth + "px",
...
/***/ function(module, exports) {
	 ...
	 * Created by Ivan on 20.11.2016.
	 */
	module.exports = function checkSolutionHelper(context) {
	    var lettersArray = context.lettersArray,
	        notEmptyLettersArray = lettersArray.filter(function (elem) {
	        return elem.char_visible != "";
	    }),
	        correctLettersArray = lettersArray.filter(function (elem) {
	        return elem.char == elem.char_visible;
	    });
	    return {
	        complete: lettersArray.length == notEmptyLettersArray.length,
	        correct: notEmptyLettersArray.length == correctLettersArray.length
	    };
	};
...
/***/ function(module, exports) {
	...
	module.exports = function dataHelper(context, data, update) {
	    context.d3.selectAll(".ark-xword-row").each(function (d, j) {
	        context.d3.select(this).selectAll(".ark-xword-cell").each(function (p, i) {
	            if (!update) {
	                // init grid
	                var class_name,
	                    words = [];
	                ...
	                if (data[j][i] == null) {
	                    class_name = "ark-xword-cell-empty";
	                } else {
	                    class_name = "ark-xword-cell-word";
	                    context.lettersArray.push(data[j][i]);

	                    if (data[j][i]["across"]) {
	                        words.push(data[j][i]["across"]["index"]);
	                    }
	                    if (data[j][i]["down"]) {
	                        words.push(data[j][i]["down"]["index"]);
	                    }
	                    ...
	                    context.d3.select(this).attr("data-row", j).attr("data-col", i);
	                }

	                // class_name = context.d3.select(this).attr("class") + " " + class_name;

	                context.$(this).addClass(class_name);
	            } else {
	                // update grid
	                if (data[j][i] != null) {
	                    var dataObj = context.$(this).data().dataItem;

	                    if (dataObj.selected) {
	                        context.$(this).addClass("selected");
	                    } else {
	                        context.$(this).removeClass("selected");
	                    }

	                    if (dataObj.current) {
	                        context.$(this).addClass("current");
	                    } else {
	                        context.$(this).removeClass("current");
	                    }

	                    if (context.mismatchHighliting && dataObj.char != dataObj.char_visible) {
	                        context.$(this).addClass("mismatch");
	                    } else {
	                        context.$(this).removeClass("mismatch");
	                    }
	                }
	            }
	        }).html(function (p, i) {
	            if (data[j][i] !== null) {
	                return data[j][i]["char_visible"];
	            }
	        });
	    });
	};
...
/***/ function(module, exports) {
	...
	module.exports = "#ark-component-content-html {\n  border: 2px solid #C12127;\n  display: block;\n  position: relative;\n}\nark-xword-greetings {\n  display: block;\n  background-color: #C12127;\n  color: #fff;\n  text-align: center;\n  padding: 20px;\n  font-size: 36px;\n  font-weight: bold;\n}\nark-xword {\n  display: block;\n}\nark-xword:after {\n  content: no-open-quote;\n  display: table;\n  clear: both;\n}\nark-xword-container {\n  padding: 20px;\n  display: block;\n  float: left;\n  width: 50%;\n  border-right: 2px solid #C12127;\n}\nark-xword-definition {\n  float: left;\n  padding: 20px;\n  width: 50%;\n  display: block;\n  box-sizing: border-box;\n  color: #333;\n  font-size: 20px;\n  border-left: 2px solid #C12127;\n  margin-left: -2px;\n  margin-right: -2px;\n}\nark-xword-definition-header {\n  display: block;\n  margin-bottom: 10px;\n  font-size: 24px;\n}\nark-xword-overlay {\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-content: center;\n  align-items: center;\n  position: absolute;\n  top: -9999px;\n  right: 9999px;\n  left: -9999px;\n  bottom: 9999px;\n  background-color: rgba(0, 0, 0, 0.4);\n  overflow: hidden;\n  opacity: 0;\n}\nark-xword-overlay.win,\nark-xword-overlay.fail {\n  opacity: 1;\n  top: 0;\n  right: 0;\n  left: 0;\n  bottom: 0;\n  transition: opacity .2s;\n}\nark-xword-overlay.win ark-xword-congrat,\nark-xword-overlay.fail ark-xword-fail {\n  position: relative;\n  top: 0;\n  left: 0;\n  transform: translateY(0);\n  opacity: 1;\n  transition-delay: .2s;\n  transition: opacity, transform 0.2s;\n}\nark-xword-congrat,\nark-xword-fail {\n  display: inline-block;\n  position: absolute;\n  left: -9999px;\n  top: -9999px;\n  padding: 20px;\n  border: 2px solid #C12127;\n  background-color: #ffffff;\n  min-width: 90%;\n  text-align: center;\n  transform: translateY(100%);\n  opacity: 0;\n}\nark-xword-fail-header,\nark-xword-fail-annotation {\n  display: block;\n  color: #f00;\n}\nark-xword-congrat,\nark-xword-fail-header {\n  font-size: 36px;\n  font-weight: bold;\n  text-transform: uppercase;\n}\nark-xword-congrat {\n  color: #0f0;\n}\n.ark-xword {\n  display: table;\n  empty-cells: show;\n  table-layout: fixed;\n  border-collapse: collapse;\n}\n.ark-xword-row {\n  display: table-row;\n}\n.ark-xword-cell {\n  display: table-cell;\n  vertical-align: middle;\n  text-align: center;\n  line-height: 1;\n  text-transform: uppercase;\n}\n.ark-xword-cell-word {\n  border: 1px solid #000000;\n}\n.ark-xword-cell-word.selected {\n  background-color: rgba(110, 250, 102, 0.4);\n}\n.ark-xword-cell-word.selected.current {\n  background-color: #6efa66;\n}\n.ark-xword-cell-word.mismatch {\n  color: #f00;\n}\n"

/***/ }
/******/ ]);
//# sourceMappingURL=xwordinteractive.js.map